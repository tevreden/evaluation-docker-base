...
RUN sudo apt-get update && apt-get install -y mariadb-client-core-5.5 openssh-client git build-essential cpanminus libssl-dev libexpat1-dev libgd-perl libgmp3-dev libapache2-mod-perl2 libmysqlclient-dev xfonts-base xfonts-75dpi libxrender1 fontconfig pkg-config python-pip
